      ...
      <div class="row">
        <div class="col-sm-5 text-center">
          <div class="bx-root-image">
            <img src="/assets/img/featuredProduct.jpg" class="img-fluid" alt="Something went wrong"/>
          </div>
        </div>
        <div class="col-sm-7 m-auto">
          ...
          <div class="bx-root-subtext">Inside the mind of the legendry Author JK Rowling</div>
