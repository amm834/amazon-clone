...
function onImageSelect(e) {
  index.photo = e.target.files[0];
  index.photo_name = e.target.files[0].name;
}
...
async function createProduct() {
  ...
  data.append('price', index.price);
  data.append('photo', index.photo);
  data.append('category_id', index.category_id);
  data.append('owner_id', index.owner_id);
